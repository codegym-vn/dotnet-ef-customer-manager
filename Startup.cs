...
namespace MvcCustomerManager
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string connectionString = @"Server=localhost;Database=CustomerManager10;user id=sa;password=reallyStrongPwd123;Trusted_Connection=false;ConnectRetryCount=0";
